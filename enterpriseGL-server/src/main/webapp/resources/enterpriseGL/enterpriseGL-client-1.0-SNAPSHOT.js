...
function EntModel(){this.loader=new Loader();
...
g.register();
f.setProperties({id:"part2",title:"Particella 02",body:"Particella d'esempio numero 02",relations:["part3"]});
f.register();
e.setProperties({id:"part3",title:"Particella 03",body:"Particella d'esempio numero 03",relations:[]});
e.register();
c.setProperties({id:"part4",title:"Particella 04",body:"Particella d'esempio numero 04",relations:["part1","part2"]});
c.register();
b.setProperties({id:"part5",title:"Particella 05",body:"Particella d'esempio numero 05",relations:["part3","part2"]});
b.register();
a.setProperties({id:"part6",title:"Particella 06",body:"Particella d'esempio numero 06",relations:["part1"]});
a.register();
d.setProperties({id:"event0",nametime:new Date(),descriptio:"A fist event for testing graphical system",objects:[g,f,e,c,b,a]});
d.register()
}function Simulation1(){var c=new EntEvent();
var f=new EntParticle(),e=new EntParticle(),d=new EntParticle(),b=new EntParticle(),a=new EntParticle();
f.setProperties({id:"part1",title:"Particella 01",body:"Particella d'esempio numero 01",relations:["part2","part3"]});
f.register();
e.setProperties({id:"part2",title:"Particella 02",body:"Particella d'esempio numero 02",relations:["part3"]});
e.register();
d.setProperties({id:"part3",title:"Particella 03",body:"Particella d'esempio numero 03",relations:[]});
d.register();
b.setProperties({id:"part4",title:"Particella 04",body:"Particella d'esempio numero 04",relations:["part1","part2"]});
b.register();
a.setProperties({id:"part5",title:"Particella 05",body:"Particella d'esempio numero 05",relations:["part3","part2"]});
a.register();
...
}}b.setProperties({id:"part"+f,title:"Particella "+f,body:"Particella d'esempio numero "+f,relations:k});
b.register();
d.push(b)
